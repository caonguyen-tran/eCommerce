# Generated by Django 5.0 on 2023-12-25 13:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='eCommerceApp.role')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='eCommerceApp.cart')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            name='ReviewProduct',
            fields=[
                ('review_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='eCommerceApp.review')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eCommerceApp.product')),
            ],
            bases=('eCommerceApp.review',),
        ),
        migrations.CreateModel(
            name='ReviewSeller',
            fields=[
